...
<head>
  ...
  <link rel="stylesheet" href="css/viewmarket.css">
   ...
   <div id="home">
       ...
       <nav>
         <ul class="mainMenu">
             ...
             <li><a href="#">MARKET
              ...
              <ul class="subMenu">
                  <li><a href="addcommodity.php">ADD COMMODITY</a></li> </li>
    ...
    <form action="">
       <table border="2px" id="tablebox" class="center" >
          ...
          <tr>
               <td><input type="checkbox" name="" id="box"></td> 
               <td>Andhr Pradesh</td>
               <td>Krishna</td>
               <td>Vijayawada</td>
         </tr>
         ...
         <tr>
               <td><input type="checkbox" name="" id="box"></td> 
               <td id="state">Karnataka</td>
               <td id="district">manglore</td>
               <td id="market">Hampankatta</td>
         </tr>
      </table>
...
<section id="last-backimage">
      ...
      <script src="js/viewmarket.js"></script>
  </body>
</html>
