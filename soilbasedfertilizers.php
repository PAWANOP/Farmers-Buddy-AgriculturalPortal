...
<head>
  ...
  <link rel="stylesheet" href="css/soilbased.css">
   ...
   <div id="home">
    <div class="container-1">
       ...
       <nav>
        ...
        <div id="heading-name" >
          <h1 style="margin-left: 178px; margin-top: 70px; font-size: 25px;">Fertilizer Information</h1>
        </div>
     <div id="soilbasedfertilizers">
       <form action="crop_fert1.php">
         <div id="areawisescrops-state">
           <label for="">State</label>
           <select name="viewstate" id="viewstate-soilbased" onchange="makeSubmenu(this.value)">
         ...
         <div id="viewdistrict-soil-based">
           <label for="">District</label>
           <select name="viewdistricts" id="viewdistricts-soil-based-fert">
             <option value="" disabled selected>SELECT</option>
             <!-- <option value="AndhraPradesh">Bangalore</option>
             <option value="TamilNadu">Jagatsingh pur</option>
             <option value="TamilNadu">Mysore</option> -->
           </select>
         </div>
         <div id="viewdtype-soil-based">
           <label for="">Type</label>
           <select name="viewdistricts" id="viewdtypes-soil-based">
             <option value="" disabled selected>SELECT</option>
         ...
         <div id="viewseason-soil-based">
           <label for="">Season</label>
           <select name="viewdistricts" id="viewseasons-soil-based">
             <option value="" disabled selected>SELECT</option>
             <option value="AndhraPradesh">Rabhi</option>
             <option value="CashCrops">Cash Crops</option>
             <option value="Kharif">Kharif</option>
           </select>
         </div>
         <div id="button-soilbased">
...
<section id="last-backimage">
      ...
      <footer>
         ...
         <script src="js/soilbasedfertilizer.js"> </script>
</body>
</html>