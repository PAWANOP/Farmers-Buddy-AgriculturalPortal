...
if(isset($_POST['state'])){
  ...
  $state = $_POST['state'];
  $soiltypename = $_POST['soiltypename'];
  $Districtnamesreport = $_POST['Districtnamesreport'];
 

  $sql ="INSERT INTO `commdity`.`commdity` (`state`,`soiltypename`,`soiltypename`,`Districtnamesreport`,`date&time`) VALUES ('$state','$soiltypename','$soiltypename','$Districtnamesreport' current_timestamp());";
...
<head>
  ...
  <link rel="stylesheet" href="css/addmarketreport.css">
...
<body>
   <div id="home">
    <div class="container-1">
     ...
     <div id="addmarketreport">
       <form action="storemarketdatails.php">
         <div id="addmarket-report">
           <label for="">State</label>
           <select name="state" id="addmarketreports" onchange="makeSubmenu(this.value)">
         ...
         <div id="District-name-report">
           <label for="" >District</label>
           <select name="Districtnamesreport" id="Districtnamesreports">
              <option value="">SELECT</option>
           </select>
         </div>
         <div id="submit-button-add-report">
...
<section id="last-backimage">
      ...
      <footer>
        ...
        <script src="js/addmarketreport.js"></script>
</body>
</html>