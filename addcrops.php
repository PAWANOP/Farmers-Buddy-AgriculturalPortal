...
if(isset($_POST['CommodityName'])){
  ...
  $sql ="INSERT INTO `commdity`.`commdity` (`SoialNames`,`soiltypename`,`Cropname`,`Seasons`,`date&time`) VALUES ('$soiltypename','$soiltypename','$Cropname','$Seasons' current_timestamp());";
...
<head>
  ...
  <link rel="stylesheet" href="css/logindone.css">
  <link rel="stylesheet" href="css/addcrops.css">
   ...
   <div id="home">
    <div class="container-1">
     ...
     <div id="addcrops">
       <form action="">
         <div id="soilname">
           <label for="SoialNames">SoiL Name</label>
           <select name="SoialNames" id="SoialNames">
         ...
         <div id="type">
           ...
           <select name="soiltypename" id="typename">
             <option value="" disabled selected>SELECT</option>
         ...
         <div id="Season">
           ...
           <select name="Seasons" id="Seasons">
             <option value="" disabled selected>SELECT</option>
             <option value="Rabhi">Rabhi</option>
...
<section id="last-backimage">
    ...
    <script src="js/addcrops.js"></script>
</body>
</html>