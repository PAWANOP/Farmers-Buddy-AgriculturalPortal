...
<head>
  ...
  <link rel="stylesheet" href="css/crop_fert1.css">
   ...
   <div id="home">
    ...
    <form action="">
       <table border="2px" id="tablebox" class="center" >
          ...
          <tr>
              <td >Black Soil</td>
              <td >Nitrogen(N) 1.9kg </td>
              <td >Phosporus(P205) 6.5kg</td>
              <td >Cofeecreamer 7.2kg</td>
              <td >15.6kg</td>
         </tr><tr>
              <td >Alluvial Soil</td>
              <td >Nitrogen(N) 3.5kg </td>
              <td >Phosporus(P205) 9.5kg</td>
              <td >Cofeecreamer 6.2kg</td>
              <td >19.2kg</td>
         </tr><tr>
              <td id="SoiLName">Red Soil</td>
              <td id="nitro">Nitrogen(N) 1.5kg </td>
              <td id="phos">Phosporus(P205) 2.5kg</td>
              <td id="cof">Cofeecreamer 1.2kg</td>
              <td id="total">5.2kg</td>
         </tr>
      </table>
...
<section id="last-backimage">
      ...
      <script src="js/crop_fert1.js"></script>
  </body>
</html>
