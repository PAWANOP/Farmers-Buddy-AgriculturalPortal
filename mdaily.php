...
<head>
  ...
  <link rel="stylesheet" href="css/marketwisedaily.css">
  <link rel="stylesheet" href="css/mdaily.css">
...
<body>
   <div id="home">
    <div class="container-1">
     ...
     <div id="marketwise">
       <form action="">
         <div id="marketwise-state">
           ...
           <select name="viewstate" id="marketwisedaily">
         ...
         <div id="marketwise-date">
           <label for="">Date</label>
           <input type="date" name="" id="marketwise-date-d">
         </div>
     ...
     <form action="">
      <table border="3px" id="tablebox" class="center" >
      <tr>
            <th>Market</th>
            <th>Commidity</th>
            <th>Arrivals</th>
        ...
        <tr>
         ...
         <tr>
             <td id="SoiLName">Mysore</td>
             <td id="type">Chillies</td>
             <td id="cropname">75</td>
             <td id="cropname">Tonnes</td>
             <td id="cropaname">2019-10-06</td>
             <td id="phos">Fine</td>
             <td id="coffeee">540</td>
             <td id="nitro">720</td>
             <td id="phos">550</td>
             <td id="coffeee">Rs.quental</td>
        </tr>
     </table>
