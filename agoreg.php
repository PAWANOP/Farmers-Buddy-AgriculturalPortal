...
<head>
  ...
  <link rel="stylesheet" href="css/viewago.css">
   ...
   <div id="home">
       ...
       <nav>
         <ul class="mainMenu">
           ...
           <ul class="subMenu">
                  ...
                  <li><a href="changesecuq.php">CHANGE SECURITY QUESTION</a></li>
              </ul>
    ...
    <form action="">
       <table border="2px" id="tablebox" class="center" >
          ...
          <tr>
              <td id="firstname">Pawan</td>
              <td id="lastnmae">Siliwal</td>
              <td id="dob">06-08-1999</td>
              <td id="count">India</td>
              <td id="st">Maharashtra</td>
              <td id="ct">Amravati</td>
              <td id="gd">Gardener</td>
              <td id="ds">HSC 12th</td>
              <td id="em">Pawanjangidjbr@gmail.com</td>
         </tr>
      </table>
        <input type="Submit" name="" id="accept" value="Accept">
     </form>
    </div>
</div>
...
<section id="last-backimage">
      ...
      <script src="js/viewago.js"></script>
  </body>
</html>
