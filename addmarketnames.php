...
if(isset($_POST['state'])){
  ...
  $state = $_POST['state'];
  $Districtnames = $_POST['Districtnames'];
  $Marketarea = $_POST['Marketarea'];
 

  $sql ="INSERT INTO `market_report`.`market_report` (`state`,`Districtnames`,`Marketarea`,`date&time`) VALUES ('$state','$Districtnames','$Marketarea',current_timestamp());";
...
<head>
  ...
  <link rel="stylesheet" href="css/addmarketnames.css">
...
<body>
   <div id="home">
    <div class="container-1">
     ...
     <div id="addmarketnames">
       <form action="">
         <div id="addmarket-state">
           <label for="">State</label>
           <select name="state" id="addmarket">
         ...
         <div id="District-name">
           ...
           <select name="Districtnames" id="Districtnames">
             <option value="" disabled selected>SELECT</option>
             <option value="Crops">Bangalore</option>
         ...
         <div id="submit-button-add">
           <input type="Submit" value="Add" id="submit-button" onclick="handleSubmit()">
          </div>
       </form>
     </div>
</div>
...
<section id="last-backimage">
    ...
    <script src="js/addmarketanmes.js"></script>
</body>
</html>