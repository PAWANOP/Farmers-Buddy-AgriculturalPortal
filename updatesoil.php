...
<head>
  ...
  <link rel="stylesheet" href="css/updatesoil.css">
     ...
     <div id="updatesoil-name">
       <form action="">
         <div id="sent-mail-item">
          ...
          <div id="button-update-soil">

           <input type="button" value="Add New" onclick="javascript:location.href='addsoil.php'"/>
