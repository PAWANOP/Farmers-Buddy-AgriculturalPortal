...
<head>
  ...
  <link rel="stylesheet" href="css/viewsistrict.css">
         ...
         <ul class="mainMenu">
             ...
             <li><a href="#">MARKET
              ...
              <ul class="subMenu">
                  ...
                  <li><a href="addcommodity.php">ADD MARKETNAMES</a></li>
     ...
     <div id="viewsdistrict">
       ...
       <table border="2px" id="tablebox" class="center" >
         ...
         <tr>
          ...
          <tr>
              <td id="box"><input type="checkbox" name="" id=""></td>
              <td>Amravati</td>
              <td>Alluvial Soil</td>
         </tr>
          <tr>
         ...
         <div id="button-viw-district">
           <input type="Submit" name="" id="" value="Add New">
...
<script src="js/viewdistrict.js"></script>
</body>
</html>