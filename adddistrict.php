...
if(isset($_POST['State'])){
  ...
  $sql ="INSERT INTO `viewdistrict`.`viewdistrict` (`State`,`District`,`soiltypes`,`date&time`) VALUES ('$State','$District','$soiltype', current_timestamp());";
...
<head>
  ...
  <link rel="stylesheet" href="css/adddistrict.css">
...
<body>
   <div id="home">
    <div class="container-1">
     ...
     <div id="adddistrict-head" style="margin-left: 220px; margin-top: 90px;">
       <h1 style="font-size: 25px;">Add District</h1>
     </div>
     <div id="adddistrict">
       <form action="">
         <div id="adddistrict-state" style="margin-bottom: 10px;">
           <label for="">State</label>
           <select name="State" id="State-adddist" onchange="makeSubmenu(this.value)">
         ...
         <div id="adddistrict-district" style="margin-bottom: 10px;">
           <label for="">District</label>
           <select name="District" id="District-adddist">
            <option value="" selected disabled>SELECT</option>
           </select>
         </div>
         <div id="CommodityNames">
           <label for="">Soil Type</label>
            <select name="soiltype" id="soiltype">
              <option value="Black Soil">Black Soil</option>
              <option value="Red Soil">Red Soil</option>
              <option value="Aluvial Soil">Aluvial Soil</option>
              <option value="Laterite Soil">Laterite Soil</option>
              <option value="Mountain Soil">Mountain Soil</option>
              <option value="Desert Soil">Desert Soil</option>
            </select>
         </div>
         <div id="adddistrict-submit">
...
<section id="last-backimage">
      ...
      <footer>
         ...
         <script src="js/adddistrict.js"></script>
</body>
</html>