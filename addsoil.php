...
$insert=false;
if(isset($_POST['SoilName'])){

  $SoilName = $_POST['SoilName'];

  $sql ="INSERT INTO `soil_info`.`soil_info` (`SoilName`,`date&time`) VALUES ('$SoilName', current_timestamp());";
...
<head>
  ...
  <link rel="stylesheet" href="css/addsoil.css">
...
<body>
   <div id="home">
    <div class="container-1">
     ...
     <h2>Soil Entry Form</h2>
     <div id="addsoil-name">
       <form action="">
         <div id="addsoil-name-area">
           <label for="">Add Soil Name</label>
           <input type="text" name="SoilName" id="addsoil">
         </div>
