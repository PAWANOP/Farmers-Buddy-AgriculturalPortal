...
if(isset($_POST['CommodityName'])){
  ...
  $sql ="INSERT INTO `commdity`.`commdity` (`CommodityName`. `date&time`) VALUES ('$CommodityName', current_timestamp());";
    ...
    <div class="container-1">
     ...
     <div id="commoditysname">
       <form action="">
         ...
         <div id="add-commidity">
           <input type="Submit" id="commodity-button" onclick="handleSubmit()">
           <input type="Reset" id="commodity-reset">
          </div>
       </form>
     </div>
</div>
...
<section id="last-backimage">
      ...
      <footer>
         ...
         <script src="js/addcom.js"></script>
</body>
</html>