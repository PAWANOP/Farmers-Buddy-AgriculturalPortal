...
<head>
  ...
  <link rel="stylesheet" href="css/commoditywise.css">
...
<body>
   <div id="home">
    <div class="container-1">
     ...
     <div id="commditywise">
       <form action="cmdwiserpt.php">
         <div id="commoditywise-state">
           <label for="">State</label>
           <select name="viewstate" id="viewstate-commoditywise">
         ...
         <div id="viewseason-commodity-wise">
           <label for="" >Commodity</label>
           <select name="viewdistricts" id="viewseasons-commodity-wise">
             <option value="" disabled selected>SELECT</option>
