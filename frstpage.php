...
<head>
  ...
  <link rel="stylesheet" href="css/sentmails.css">
...
<body>
  <div id="home">
   ...
   <div id="sentitems" style="margin-left: 230px; margin-top: 100px;" >
    <h1 style="font-size: 25px; color:rgb(0, 120, 62);">Sent Items</h1>
  </div>
  <div id="sent-mail-item">
       <table border="">
         <tr>
        ...
        <tr>
          ...
          <td><a href="">pawanjangidjbr@gmail.com</a></td>
          <td><a href="">soil Information</a></td>
          <td><a href="">15-aug-2019</a></td>
        </tr>
        <tr>
          <td><input type="checkbox" name="" id="checkbox"></td>
          <td><a href="">shivam@gmail.com</a></td>
          <td><a href="">commodity information</a></td>
          <td><a href="">25-june-2021</a></td>
        </tr>
        <tr>
          <td><input type="checkbox" name="" id="checkbox"></td>
          <td><a href="">rahul@gmail.com</a></td>
          <td><a href="">trainings</a></td>
          <td><a href="">05-july-2021</a></td>
        </tr>
        <tr>
          <td><input type="checkbox" name="" id="checkbox"></td>
          <td><a href="">varun@gmail.com</a></td>
          <td><a href="">Price of grapes</a></td>
          <td><a href="">10-Dec-2020</a></td>
        </tr>
       </table>
       <div id="sending-button-mail">
