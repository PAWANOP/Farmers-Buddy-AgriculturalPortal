...
<body>
   <div id="home">
    <div class="container-1">
     ...
     <div id="front-page">
         <div id="first">
            <h1>Welcome to Farmers where Natural Food is born!</h1>
             <a href="#history">Learn More</a>
         </div>
         <div id="second">
            <button class="w3-button w3-display-left" onclick="plusDivs(-1)">&#10094;</button>
            <img  class="myslider" src="images/f-1.jpg" alt="">
            <img  class="myslider" src="images/f-2.jpg" alt="">
            <img  class="myslider" src="images/f-3.jpg" alt="">
...
<section id="last-backimage">
      ...
      <script src="js/logindone.js"></script>
</body>
</html>