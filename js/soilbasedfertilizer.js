let citiesByState  = {
  ...
  Meghalaya:['East Garo Hills','East Khasi Hills','Jaintia Hills','Ri Bhoi','South Garo Hills','West Garo Hills','West Khasi Hills']
    ...
    function makeSubmenu(value) {
      if(value.length==0) document.getElementById("viewdistricts-soil-based-fert").innerHTML = "<option></option>";
      else {
      var citiesOptions = "";
      for(cityId in citiesByState[value]) {
      citiesOptions+="<option>"+citiesByState[value][cityId]+"</option>";
      }
      document.getElementById("viewdistricts-soil-based-fert").innerHTML = citiesOptions;
      }
      }
      function displaySelected() { var country = document.getElementById("viewstate-soilbased").value;
      var city = document.getElementById("viewdistricts-soil-based-fert").value;
      alert(country+"\n"+city);
      }
      function resetSelection() {
      document.getElementById("viewstate-soilbased").selectedIndex = 0;
      document.getElementById("viewdistricts-soil-based-fert").selectedIndex = 0;
      }